...
export default class HumidityChart extends Component {
      ...
      data: {
        ...
        datasets: [
          ...
          // Temperature chart.
          {
            ...
            backgroundColor: 'rgb(189, 230, 230)',
          },
        ],
      },
      options: {
  ...
  getChartProps(chartProps) {
    const { humidityData, wellnessData } = this.props;
    ...
    // chartProps.chart.options.scales.yAxes[0].ticks.max = maxValue + 1;
  ...
  render() {
    const { humidityData, ...chartProps } = this.props;
